(function() {
    ...
    exports.fieldextract = async function(obj, callback) {
        ...
        let filename = getFileName(obj.filepath);
        if(obj.fileUrl) {
            ...
            let downloadFile = await new downloader.download(obj.fileUrl, fullpath, 0)
            if(downloadFile.success) {
                filename = '../temp/Agreement.pdf';
            } else {
        ...
        console.log('did the await work?');
